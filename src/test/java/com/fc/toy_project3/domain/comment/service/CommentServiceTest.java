...
public class CommentServiceTest {
    ...
    class Context_postComment {
        ...
        void _willSuccess() {
            //given
            CommentCreateRequestDTO commentCreateRequestDTO = new CommentCreateRequestDTO(1L, 1L,
                "여행 계획 정말 멋있다.");
            ...
            //when
            CommentResponseDTO result = commentService.postComment(commentCreateRequestDTO);
    ...
    class Context_patchComment {
        ...
        void _willSuccess() {
            ...
            //when
            CommentResponseDTO result = commentService.patchComment(commentId,
    ...
    class Context_deleteComment {
        ...
        void _willSuccess() {
            ...
            //when
            CommentDeleteResponseDTO result = commentService.softDeleteComment(commentId);
